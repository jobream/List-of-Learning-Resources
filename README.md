...
Collection of educational resources for Software Engineers

Add your favorite resources to help others on their learning journey, see [contributing](#contributing).
...
<div style="margin:30px 0 30px 0;">
  <img style="float:left;height:40px;margin-right:15px" src="https://cdn-icons-png.flaticon.com/128/2621/2621230.png">
  <h2 style="display: inline;clear:right;">Competitive Programming</h2>
</div>
...
See more [Competitive Programming resources](./resources/CompetitiveProgramming.md)

---

<div style="margin:30px 0 30px 0;">
  <img style="float:left;height:40px;margin-right:15px" src="https://cdn-icons-png.flaticon.com/128/234/234073.png">
  <h2 style="display: inline;clear:right;">Software Development</h2>
</div>
...
See more [Web Development resources](./resources/WebDevelopment.md)
...
<div style="margin:30px 0 30px 0;">
  <img style="float:left;height:40px;margin-right:15px" src="https://cdn-icons-png.flaticon.com/128/2620/2620900.png">
  <h2 style="display: inline;clear:right;">Computer Programming</h2>
</div>
...
See more [Python resources](./resources/LearnPython.md)

---

### 2. Learn Git

- [pcottle-repository](https://github.com/pcottle/learnGitBranching) - Git repository visualizer, sandbox, and a series of educational tutorials and challenges.
...
### 4. Learn Solidity Smart Contract with hardhat
...
<div style="margin:30px 0 30px 0;">
  <img style="float:left;height:40px;margin-right:15px" src="https://t4.ftcdn.net/jpg/02/41/60/35/240_F_241603570_MR6B6tQjTuREQC0EIgc7l2KvVNJzsSp5.jpg">
  <h2 name="#communities" style="display: inline;clear:right;">Communities</h2>
</div>
...
See more [Communities](./resources/Communities.md)

---

<div style="margin:30px 0 30px 0;">
  <img style="float:left;height:40px;margin-right:15px" src="https://cdn-icons-png.flaticon.com/128/3730/3730087.png">
  <h2 style="display: inline;clear:right;">Books and Video Courses</h2>
</div>
...
- [Pro Git](https://git-scm.com/book/en/v2) - This book is a comprehensive guide on version control (and it's free!)
...
<div style="margin:30px 0 30px 0;">
  <!-- add suitable image -->
  <h2 style="display: inline;clear:right;">Frontend Web Development Tools</h2>
</div>
...
See more [Web development tools](./resources/WebTools.md)

---

## Contributing

Pull requests are welcome 👍. If you know a resource, which you think others would benefit from, fork the repo, add your changes, and create a pull request!

For **major changes**, please open an issue first to discuss what you would like to change.

To learn how to contribute, read the [CONTRIBUTING.md](./CONTRIBUTING.md) file.
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><a href="https://www.linkedin.com/in/ayesha-baloch-53892120a/"><img src="https://avatars.githubusercontent.com/u/90467681?v=4?s=100" width="100px;" alt="Ayesha Baloch"/><br /><sub><b>Ayesha Baloch</b></sub></a><br /><a href="#content-ayeshabaloch123" title="Content">🖋</a></td>
